...
describe('LinearProgresBar', () => {
  ...
  eyes.it('should progress as value increase', async () => {
    ...
    const actualProgress = Math.round(
      (foregroundBarWidth / backgroundBarWidth) * 100,
    );
  ...
  eyes.it(
    'should show exactly full progress as value greater than 100',
    async () => {
  ...
  eyes.it('should show progress indicator percentages', async () => {
    const props: LinearProgressBarProps = {
