...
title: "SidebarDock",
category: "Actions",
description: "Button – docks floating panel to sidebar",
tags: ["setup", "launch", "rocket"],
sizes: { "18": "SidebarDockSmall", "24": "SidebarDock" },
  },
{
title: "SidebarUndock",
category: "Actions",
description: "Button – undocks sidebar to floating panel",
tags: ["setup", "launch", "rocket"],
sizes: { "18": "SidebarUndockSmall", "24": "SidebarUndock" },
  },
  {
    title: "Settings",
    category: "General",
  ...
  },
{
  title: "CodeArray",
  category: "General",
  description: "Button – shows an array of data objects (in code)",
  tags: ["array", "data", "code"],
  sizes: { "18": "CodeArraySmall", "24": "CodeArray" },
},
  {
    title: "CodeObject",
    category: "General",
  ...
  },
{
    title: "SelectionTool",
    category: "Composer Tools",
    description: "Button - changes cursor to selection mode",
    tags: ["cursor", "mouse"],
    sizes: { "18": "SelectionToolSmall", "24": "SelectionTool" },
},
{
    title: "SeatSelectionTool",
    category: "Composer Tools",
    description: "Button - changes cursor to seat selection mode",
    tags: ["cursor", "mouse", "venues"],
    sizes: { "18": "SeatSelectionToolSmall", "24": "SeatSelectionTool" },
},
{
    title: "PanTool",
    category: "Composer Tools",
    description: "Button - changes cursor to pan mode",
    tags: ["cursor", "mouse"],
    sizes: { "18": "PanToolSmall", "24": "PanTool" },
},
  {
    title: "Filters",
...
category: "Composer Components",
description: "Button - adds radio button group component",
tags: ["Component", "Form"],
sizes: { "18": "RadioButtonGroupSmall", "24": "RadioButtonGroup" },
},
{
title: "Multi Select",
category: "Composer Components",
description: "Button - adds multiselect component",
tags: ["Component", "Form"],
sizes: { "18": "MultiSelectSmall", "24": "MultiSelect" },
},
{
title: "Checkbox",
category: "Composer Components",
description: "Button - adds checkbox component",
tags: ["Component", "Form"],
sizes: { "18": "CheckboxSmall", "24": "Checkbox" },
},
{
title: "Dropdown",
category: "Composer Components",
description: "Button - adds dropdown component",
tags: ["Component", "Form"],
sizes: { "18": "DropdownSmall", "24": "Dropdown" },
},
{
title: "User Name",
category: "Composer Components",
description: "Button - adds input for user name",
tags: ["Component", "Form"],
sizes: { "18": "UserNameSmall", "24": "UserName" },
},
{
title: "E Signature",
category: "Composer Components",
description: "Button - adds e-signature component",
tags: ["Component", "Form"],
sizes: { "18": "ESignatureSmall", "24": "ESignature" },
},
  ...
  },
  {
    title: "AdmissionArea",
    category: "Composer Venues",
    description: "Button - enables admission area drawing",
    tags: ["venues"],
    sizes: { "18": "AdmissionAreaSmall", "24": "AdmissionArea" },
  },
{
    title: "Bar",
    category: "Composer Venues",
    description: "Button - changes icon to bar in the canvas",
    tags: ["venues"],
    sizes: { "18": "BarSmall", "24": "Bar" },
},
{
    title: "Elevator",
    category: "Composer Venues",
    description: "Button - changes icon to elevator in the canvas",
    tags: ["venues"],
    sizes: { "18": "ElevatorSmall", "24": "Elevator" },
},
{
    title: "MultiRow",
    category: "Composer Venues",
    description: "Button - enables multiple row drawing",
    tags: ["venues"],
    sizes: { "18": "MultiRowSmall", "24": "MultiRow" },
},
{
    title: "SeatRow",
    category: "Composer Venues",
    description: "Button - enables row drawing",
    tags: ["venues"],
    sizes: { "18": "SeatRowSmall", "24": "SeatRow" },
},
{
    title: "Smoking",
    category: "Composer Venues",
    description: "Button - changes icon to smoking in the canvas",
    tags: ["venues"],
    sizes: { "18": "SmokingSmall", "24": "Smoking" },
},
{
    title: "Stairs",
    category: "Composer Venues",
    description: "Button - changes icon to stairs in the canvas",
    tags: ["venues"],
    sizes: { "18": "StairsSmall", "24": "Stairs" },
},
{
    title: "TableRound",
    category: "Composer Venues",
    description: "Button - enables round table drawing",
    tags: ["venues"],
    sizes: { "18": "TableRoundSmall", "24": "TableRound" },
},
{
    title: "TableSquare",
    category: "Composer Venues",
    description: "Button - enables square table drawing",
    tags: ["venues"],
    sizes: { "18": "TableSquareSmall", "24": "TableSquare" },
},
{
    title: "Wc",
    category: "Composer Venues",
    description: "Button - changes icon to WC in the canvas",
    tags: ["venues"],
    sizes: { "18": "WcSmall", "24": "Wc" },
},
{
    title: "WcMen",
    category: "Composer Venues",
    description: "Button - changes icon to WC men in the canvas",
    tags: ["venues", "toilet"],
    sizes: { "18": "WcMenSmall", "24": "WcMen" },
},
{
    title: "WcWomen",
    category: "Composer Venues",
    description: "Button - changes icon to WC women in the canvas",
    tags: ["venues", "toilet"],
    sizes: { "18": "WcWomenSmall", "24": "WcWomen" },
},
  {
    title: "FoodInStock",
    category: "Food",
  ...
  },
{
    title: "Microsoft",
    category: "Brands",
    description: "Button - connects to microsoft outlook",
    tags: ["search", "social"],
    sizes: { "18": "MicrosoftSmall", "24": "Microsoft" },
  },
{
    title: "Apple",
    category: "Brands",
    description: "Button - connects to apple calendar",
    tags: ["search", "social"],
    sizes: { "18": "AppleSmall", "24": "Apple" },
  },
  {
